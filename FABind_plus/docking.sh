#!/bin/bash
index_csv=/mnt/data/posebusters_fabindplus/ligands.csv
pdb_file_dir=/mnt/data/posebusters_fabindplus/pdb_files
num_threads=1
save_pt_dir=/mnt/data/posebusters_fabindplus/temp_files
